...
// region PagedEmbed
//======================================================================================================================
PagedEmbed::PagedEmbed(sld::Snowflake<sld::Channel> channelId, Filter filter)
...
void PagedEmbed::applyListWithFilter(const CacheMap &cache)
{
    ...
    if (types.contains(EntityType::Namespace))
    {
        ...
        {
            const NamespaceDef &ns_def = static_cast<const NamespaceDef&>(def.get());
    ...
    if (types.contains(EntityType::Class))
    {
        ...
        {
            const ClassDef &cs_def = static_cast<const ClassDef&>(def.get());
    ...
    if (types.contains(EntityType::Enum))
    {
        ...
        {
            const MemberDef &en_def = static_cast<const MemberDef&>(def.get());
    ...
    if (types.contains(EntityType::Function))
    {
        ...
        {
            const MemberDef &fn_def = static_cast<const MemberDef&>(def.get());
    ...
    if (types.contains(EntityType::Field))
    {
        ...
        {
            const MemberDef &var_def = static_cast<const MemberDef&>(def.get());
    ...
    if (types.contains(EntityType::TypeAlias))
    {
        ...
        {
            const MemberDef &aka_def = static_cast<const MemberDef&>(def.get());
...
void PagedEmbed::setMessageId(sld::Snowflake<sld::Message> parMessageId) { messageId = parMessageId; }
...
//======================================================================================================================
sld::Embed PagedEmbed::toEmbed() const
{
